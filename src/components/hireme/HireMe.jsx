function HireMe() {
  return (
    <>
      <section className="flex md:flex-col items-center justify-center md:w-full font-mono w-screen md:h-auto h-auto md:mb-36 mb-24 md:mt-24 px-6 mt-16">
        <form
          action=""
          className="flex flex-col items-center justify-center md:w-full font-mono w-screen md:h-auto h-auto md:mb-36 mb-24"
        >
